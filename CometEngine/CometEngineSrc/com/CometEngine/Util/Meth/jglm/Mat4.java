 ...
 */
package com.CometEngine.Util.Meth.jglm;
...
public final class Mat4 extends AbstractMat {
	 ...
	 *            fourth column, w
	 */
	public Mat4(final float x00, final float x01, final float x02, final float x03, final float x10, final float x11,
			final float x12, final float x13, final float x20, final float x21, final float x22, final float x23,
	...
	public boolean isIdentity() {
		return Compare.equals(m00, 1f, Compare.MAT_EPSILON) && Compare.equals(m11, 1f, Compare.MAT_EPSILON)
				&& Compare.equals(m22, 1f, Compare.MAT_EPSILON) && Compare.equals(m33, 1f, Compare.MAT_EPSILON)

				&& Compare.equalsZero(m01) && Compare.equalsZero(m02) && Compare.equalsZero(m03)

				&& Compare.equalsZero(m10) && Compare.equalsZero(m12) && Compare.equalsZero(m13)

				&& Compare.equalsZero(m20) && Compare.equalsZero(m21) && Compare.equalsZero(m23)

				&& Compare.equalsZero(m30) && Compare.equalsZero(m31) && Compare.equalsZero(m32);
	}

	@Override
	public boolean isZero() {
		return Compare.equalsZero(m00) && Compare.equalsZero(m01) && Compare.equalsZero(m02) && Compare.equalsZero(m03)

				&& Compare.equalsZero(m10) && Compare.equalsZero(m11) && Compare.equalsZero(m12)
				&& Compare.equalsZero(m13)

				&& Compare.equalsZero(m20) && Compare.equalsZero(m21) && Compare.equalsZero(m22)
	...
	public Mat4 multiply(final Mat4 right) {
		...
		return new Mat4(nm00, nm01, nm02, nm03, nm10, nm11, nm12, nm13, nm20, nm21, nm22, nm23, nm30, nm31, nm32, nm33);
	}
	...
	public Mat4 subtract(final Mat4 right) {
		return new Mat4(m00 - right.m00, m01 - right.m01, m02 - right.m02, m03 - right.m03, m10 - right.m10,
				m11 - right.m11, m12 - right.m12, m13 - right.m13, m20 - right.m20, m21 - right.m21, m22 - right.m22,
				m23 - right.m23, m30 - right.m30, m31 - right.m31, m32 - right.m32, m33 - right.m33);
	}
	...
	public Mat4 add(final Mat4 other) {
		return new Mat4(m00 + other.m00, m01 + other.m01, m02 + other.m02, m03 + other.m03, m10 + other.m10,
				m11 + other.m11, m12 + other.m12, m13 + other.m13, m20 + other.m20, m21 + other.m21, m22 + other.m22,
				m23 + other.m23, m30 + other.m30, m31 + other.m31, m32 + other.m32, m33 + other.m33);
	}
	...
	public Mat4 translate(final Vec3 translation) {
		...
		return new Mat4(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, result.x, result.y, result.z,
				result.w);
	}
	...
	public boolean equalsWithEpsilon(final Mat obj, final float epsilon) {
		...
		return Compare.equals(m00, other.m00, epsilon) && Compare.equals(m01, other.m01, epsilon)
				&& Compare.equals(m02, other.m02, epsilon) && Compare.equals(m03, other.m03, epsilon)

				&& Compare.equals(m10, other.m10, epsilon) && Compare.equals(m11, other.m11, epsilon)
				&& Compare.equals(m12, other.m12, epsilon) && Compare.equals(m13, other.m13, epsilon)

				&& Compare.equals(m20, other.m20, epsilon) && Compare.equals(m21, other.m21, epsilon)
				&& Compare.equals(m22, other.m22, epsilon) && Compare.equals(m23, other.m23, epsilon)

				&& Compare.equals(m30, other.m30, epsilon) && Compare.equals(m31, other.m31, epsilon)
				&& Compare.equals(m32, other.m32, epsilon) && Compare.equals(m33, other.m33, epsilon);
	}
