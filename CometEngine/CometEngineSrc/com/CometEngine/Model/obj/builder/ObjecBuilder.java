package com.CometEngine.Model.obj.builder;
...
import com.CometEngine.Model.obj.parser.BuilderInterface;
import com.CometEngine.Resrouce.CEModelResource;
import com.CometEngine.Resrouce.CEResource;

public class ObjecBuilder extends CEModelResource implements BuilderInterface {
	...
	public static final String DEFAULT_GROUP = "_OBJ_DEFAULT_OBJECT__";
	...
	public String objectName = "_OBJ_DEFAULT_OBJECT";;
	...
	public void setCurrentGroupNames(String[] names) {
		...
		for (int loopi = 0; loopi < names.length; loopi++) {
			...
			currentGroupFaceLists.add(groups.get(CurrentObj).get(group));
